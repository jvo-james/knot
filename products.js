    ...
    <section class="product-hero">
      ...
      <div class="product-hero__content">
        ...
        <div class="action-row">
          <button class="btn btn-dark add-btn--product ${isInCart(product.slug) ? 'is-in-cart' : ''}" type="button" data-add-to-cart="${product.slug}" data-product-toggle>${isInCart(product.slug) ? 'Add Another' : 'Add to Cart'}</button>
          <a class="btn btn-light btn-light--dark" href="products.html">Back to products</a>
        </div>
        <div class="product-state">${isInCart(product.slug) ? 'This item is already in your cart. Tap Add Another to increase the quantity.' : 'This item is ready to add to your cart.'}</div>
      </div>
    </section>
